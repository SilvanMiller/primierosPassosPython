...
# -------------------------------
'''
print('EX037 - A confereração nacional de natação precisa de um progrma que leia o ano de nascimento de um atleta e mostre sua categoria de acordo com a sua idade: até 9 anos MIRIM - até 14 anos INFANTIL - até 19 anos JUNIOR - até 20 anos SÊNIOR - Acime MASTER')


print('\n')
# -------------------------------
'''
print('EX038 - Escreva um programa que leia dois números interiros e compare-os, mostrando na tela uma msg: "Primeiro número é maior - Segndo número é maior" - Os número são iguais')
